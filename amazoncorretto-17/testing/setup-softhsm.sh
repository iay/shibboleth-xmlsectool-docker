...
# Load the credential
keytool -importkeystore --addprovider SunPKCS11 -providerarg pkcs11-softhsm.cfg \
    -srcstoretype pkcs12 -srckeystore secrets/self-signed.p12 -srcstorepass password \
    -deststoretype PKCS11 -destkeystore NONE -deststorepass 12341234

keytool -list --addprovider SunPKCS11 -providerarg pkcs11-softhsm.cfg \
